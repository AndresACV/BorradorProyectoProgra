...
public class TableModelSucursales extends AbstractTableModel implements javax.swing.table.TableModel {
    List<Sucursal> rows;
    int[] cols;

    public TableModelSucursales(int[] cols, List<Sucursal> rows){
        initColNames();
        this.cols=cols;
        this.rows=rows;
    }
